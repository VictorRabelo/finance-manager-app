...
extension ExpenseModelByIndex on IsarCollection<ExpenseModel> {
  Future<ExpenseModel?> getByOriginalId(String originalId) {
    return getByIndex(r'originalId', [originalId]);
  }

  ExpenseModel? getByOriginalIdSync(String originalId) {
  ...
  Future<List<ExpenseModel?>> getAllByOriginalId(
      List<String> originalIdValues) {
    final values = originalIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'originalId', values);
  }

  List<ExpenseModel?> getAllByOriginalIdSync(List<String> originalIdValues) {
    final values = originalIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByOriginalId(ExpenseModel object) {
    return putByIndex(r'originalId', object);
  }

  Id putByOriginalIdSync(ExpenseModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'originalId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByOriginalId(List<ExpenseModel> objects) {
    return putAllByIndex(r'originalId', objects);
  }

  List<Id> putAllByOriginalIdSync(List<ExpenseModel> objects,
      {bool saveLinks = true}) {
...
extension ExpenseModelQueryWhere
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterWhereClause> originalIdEqualTo(
      String originalId) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByOriginalId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> sortByVoiceNotePath() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQuerySortThenBy
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByOriginalId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'originalId', Sort.asc);
    });
  }
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QAfterSortBy> thenByVoiceNotePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'voiceNotePath', Sort.asc);
    });
  }
...
extension ExpenseModelQueryWhereDistinct
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByOriginalId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseModel, ExpenseModel, QDistinct> distinctByVoiceNotePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseModelQueryProperty
  ...
  QueryBuilder<ExpenseModel, String, QQueryOperations> originalIdProperty() {
    return QueryBuilder.apply(this, (query) {
